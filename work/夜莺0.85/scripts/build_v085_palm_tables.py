#!/usr/bin/env python3
"""把夜莺 0.8.5 正式码表转换为手心输入法挂接表与辅助码表。"""
...
def main() -> None:
    ...
    attachment_path = args.output_dir / "夜莺码v0.8.5电脑手心挂接.txt"
    no_two_character_words_path = args.output_dir / "夜莺码v0.8.5电脑手心无二字词版.txt"
    auxiliary_path = args.output_dir / "夜莺码v0.8.5电脑手心辅助码.txt"
    auxiliary_unicode_path = args.output_dir / "夜莺码v0.8.5电脑手心辅助码_Unicode.txt"
