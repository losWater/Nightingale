...
SINGLE_PATH = RELEASE / "01_正式码表" / "夜莺码v0.9.1单字版.txt"
LAYOUT_PATH = RELEASE / "01_正式码表" / "夜莺码v0.9.1键位布局.yaml"
...
OUTPUT_HTML = OUTPUT_DIR / "夜莺码v0.9.1必拆字练习.html"
...
def build_questions() -> tuple[list[dict], list[dict]]:
    ...
    random.Random("nightingale-v0.9.1-must-split-root-groups-v2").shuffle(groups)
