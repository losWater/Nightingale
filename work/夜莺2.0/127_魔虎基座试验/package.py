...
H = os.path.dirname(os.path.abspath(__file__)); PKG = H + '/夜莺魔虎试验版'; Z = H + '/夜莺2.0_Rime主力版.zip'; n = 0
with zipfile.ZipFile(Z + '.tmp', 'w', zipfile.ZIP_DEFLATED, compresslevel=6) as z:
    ...
    z.write(H + '/upstream/model/mohu-sentence-ngram-v5.bin', 'mohu/model/mohu-sentence-ngram-v5.bin', compress_type=zipfile.ZIP_STORED); n += 1
os.replace(Z + '.tmp', Z)
