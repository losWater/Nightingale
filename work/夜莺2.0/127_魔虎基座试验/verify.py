...
H = os.path.dirname(os.path.abspath(__file__)); PKG = H + '/Rime_夜莺主力'; T = 'E:/ymt'
...
os.link(H + '/upstream/model/mohu-sentence-ngram-v5.bin', T + '/yeying/model/mohu-sentence-ngram-v5.bin'); shutil.copy2(H + '/upstream/pkg/default.yaml', T + '/default.yaml')
g = collections.defaultdict(list)
for l in open(PKG + '/yeying_flypy_fixed.dict.yaml', encoding='utf-8'):
    f = l.rstrip('\n').split('\t')
