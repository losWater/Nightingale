...
for l in open(H + '/夜莺魔虎试验版/yeying_flypy_fixed.dict.yaml', encoding='utf-8'):
    f = l.rstrip('\n').split('\t')
...
p = subprocess.run(['D:/nightingale/.tmp/rime_bench.exe', 'D:/Rime/weasel-0.17.4', 'D:/Rime/weasel-0.17.4/data', 'E:/ymt', 'yeying_flypy'], input=('\n'.join(codes) + '\n').encode(), stdout=subprocess.PIPE, stderr=subprocess.PIPE, timeout=3000)
