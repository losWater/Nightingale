# 夜莺 2.0 · 码圈输入法内置用码表（20260916）

三个文件都是 UTF-8、LF、制表符分隔，"文字\t编码"，同一编码的多个条目按候选顺序排列（上面的在前）。

- 夜莺2.0_码表_字词.txt：完整码表，155140 条。含单字（8105 通用规范汉字 + 7391 扩展字）、简词、四码词、40 条快符（如 a→！、no→の，已在各自码位排好次序）。
- 夜莺2.0_单字表.txt：只有汉字，21183 条（同一字的一简/二简/三简/全码各一条）。
