...
const P='E:/夜莺2.0/work/夜莺2.0/41_分段当量高频权重试跑',W=P+'/..';
const paths={"等权": "E:/夜莺2.0/work/夜莺2.0/40_分段当量替换手感实验/替换_五万步单字表.txt", "温和": "E:/夜莺2.0/work/夜莺2.0/41_分段当量高频权重试跑/温和_五万步单字表.txt", "加强": "E:/夜莺2.0/work/夜莺2.0/41_分段当量高频权重试跑/加强_五万步单字表.txt"};
const out=[];
