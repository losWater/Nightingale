...
const rows=analyze({...cfg.form.mapping,龟:'a'},cfg.analysis?.customize??{},Object.keys(input.expected));writeFileSync(dir+'/add-gui-raw.json',JSON.stringify(rows));console.log(Object.keys(rows).length);