...
const mapping={...cfg.form.mapping,主:'a'};const rows=analyze(mapping,cfg.analysis?.customize??{},Object.keys(input.expected));writeFileSync(dir+'/add-zhu-raw.json',JSON.stringify(rows));console.log('主重拆',Object.keys(rows).length);