...
const rows=analyze({...cfg.form.mapping,龟:'a'},cfg.analysis?.customize??{},['電','篭','滝','竜','槞']);writeFileSync(dir+'/gui-bottom-extension-after.json',JSON.stringify(rows));console.log(JSON.stringify(rows));