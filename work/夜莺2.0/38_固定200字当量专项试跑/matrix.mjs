...
import{writeFileSync}from'node:fs';const m={};for(const a of "abcdefghijklmnopqrstuvwxyz ;'456789")for(const b of "abcdefghijklmnopqrstuvwxyz ;'456789")m[a+b]=calcEq(a+b);writeFileSync('matrix.json',JSON.stringify(m));