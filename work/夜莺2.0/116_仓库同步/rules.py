...
DIR_EXACT = {'jobs', 'round1', 'round2', 'configs', 'practice', 'raw', 'engine-check', 'engine-check-final', 'engine-check-light',
             'Rime_主力版', 'smoke', 'calibration', 'output', '__pycache__', '.candidate_check', 'node_modules', 'target'}
...
FILE_RE = [(re.compile(r'Rime主力版.*\.zip$'), '*Rime主力版*.zip'), (re.compile(r'\.(log|pyc|tmp)$'), '*.log\n*.pyc\n*.tmp'), (re.compile(r'^~\$'), '~$*'),
