...
s='<!doctype html><html lang="zh-CN"><meta charset="utf-8"><title>主读音硬约束字词避重</title><style>body{font:16px/1.7 system-ui;background:#f4f7fb;color:#234;margin:28px}table{border-collapse:collapse;background:white}td,th{border:1px solid #ccd;padding:8px}.scroll{overflow:auto}</style><h1>主读音硬约束＋字词避重</h1><p>三组均从43号s2_w50已通过保护的布局出发；原系数是该布局的历史结果，三组继续各5万步，种子202609121702，字词系数0.1/0.2/0.4。起点必须满足1643字常用主读音至少一处首选；每一步拒绝不满足的提案，与温度和分数无关。其他读音单列。</p><p>当量权重60/60/40/25/15，恢复50%跨排惩罚，其余参数不变。单种子实验，尚不能证明参数稳定最优或硬约束可行域连通。</p>'
...
s+='<section><h2>本轮结论</h2><p><strong>硬约束有效，三组均通过1643字常用主读音首选保护；原权重及2倍结果的原生码表与起点完全相同。4倍获得避重收益，同时付出当量与三码覆盖代价，暂不替换原候选。</strong></p><table><tr><th>指标</th><th>起点／原权重／2倍</th><th>4倍</th><th>变化</th></tr><tr><td>字词软碰撞（加权指标，非对数）</td><td>36.802411</td><td>23.308161</td><td>下降36.67%</td></tr><tr><td>前500键均当量</td><td>1.313208</td><td>1.315967</td><td>增加0.002759</td></tr><tr><td>前1500键均当量</td><td>1.315839</td><td>1.318751</td><td>增加0.002912</td></tr><tr><td>301–500键均当量</td><td>1.324350</td><td>1.331519</td><td>增加0.007169</td></tr><tr><td>前1500三码内字数</td><td>1365</td><td>1344</td><td>减少21字（91.0%→89.6%）</td></tr><tr><td>1501–3000非首选字数</td><td>4</td><td>11</td><td>增加7字</td></tr><tr><td>3001–6000非首选字数</td><td>83</td><td>108</td><td>增加25字</td></tr></table><p>同指大、小跨排均有改善，但小指干扰增加。后两档存在原有缺字（2、38字）；非首选统计为盒子口径，不代表受保护主音失守。全表末尾保留全部指标。</p><p>此结果只支持“守住主音保护仍能降低字词碰撞”，不能证明4倍权重整体更好。建议后续试2.5倍、3倍及多种子；本轮未继续追加。</p></section>'
...
s+='<details><summary>全部原生指标及相对原系数的变化</summary><p>指法数组的各项按引擎定义；字段保留计算，三组只调整字词软碰撞惩罚系数。覆盖率等指标增加为改善，不能把所有负差都当改善。</p>'
...
s+='<h2>普通单字表</h2>'
for x in a:
 path=P.parent/'43_保护范围审计与跨排多种子复核/s2_w50_五万步单字表.txt' if x['方案']=='原系数' else P/(x['方案']+'_五万步单字表.txt')
