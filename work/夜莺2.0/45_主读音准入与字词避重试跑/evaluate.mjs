...
const P='E:/夜莺2.0/work/夜莺2.0/45_主读音准入与字词避重试跑',W=P+'/..';
const paths={"原系数": "E:\\夜莺2.0\\work\\夜莺2.0\\43_保护范围审计与跨排多种子复核\\s2_w50_五万步单字表.txt", "避重2倍": "E:\\夜莺2.0\\work\\夜莺2.0\\45_主读音准入与字词避重试跑\\避重2倍_五万步单字表.txt", "避重4倍": "E:\\夜莺2.0\\work\\夜莺2.0\\45_主读音准入与字词避重试跑\\避重4倍_五万步单字表.txt"};
const out=[];
