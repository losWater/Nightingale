...
pairs=dict(x.split(':') for x in 'cs:cl dc:dl gr:gp gv:gi jm:jz lp:lf mj:mr mu:mx nj:nz pi:pe pk:px po:ps qx:qo tv:tl uj:us vg:vk xq:xo yj:yf yu:yg zs:zl'.split())
